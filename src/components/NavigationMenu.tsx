...
const components = [
    ...
    { title: "Sobre", href: "aboutus", description: "Conheça mais sobre a história do clube." },
    { title: "Galeria", href: "/#gallery", description: "Confira fotos dos momentos mais marcantes vividos do nosso clube." },
    { title: "Contato", href: "/aboutus#contact", description: "Entre em contato com um de nossos diretores." }
]
